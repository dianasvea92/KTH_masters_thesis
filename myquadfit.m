function [resids, mycoeffs] = myquadfit(X1, Y1)
%CREATEFIGURE(X1, Y1)
%  X1:  vector of x data
%  Y1:  vector of y data

%  Auto-generated by MATLAB on 04-Apr-2018 11:40:47
...
% Create plot
plot1 = plot(X1,Y1,'Parent',axes1,'DisplayName','data1');
...
set(residPlot1(1), 'color', [0.494 0.184 0.556]);
